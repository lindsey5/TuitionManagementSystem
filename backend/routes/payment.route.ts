...
import { createPayment, getMyPayments, getOverduePayments, getPaymentById, getPayments } from "../controllers/payment.controller";
...
router.get('/overdue', requireAuth('admin', 'registrar'), getOverduePayments);
